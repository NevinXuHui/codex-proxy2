export const translations = {
  en: {
    ...
    generalSettingsAutoUpdate: "Auto Update",
    generalSettingsAutoUpdateHint: "Automatically download and apply updates when available.",
    proxyExport: "Export",
    proxyImport: "Import",
  ...
  zh: {
    ...
    generalSettingsAutoUpdate: "自动更新",
    generalSettingsAutoUpdateHint: "检测到新版本时自动下载并应用更新。",
    proxyExport: "导出",
    proxyImport: "导入",
